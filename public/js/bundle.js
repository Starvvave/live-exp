...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"share.js":[function(require,module,exports) {
"use strict";
...
var createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(review, rating, performancer, date, location) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Shared your experience!");
          }
          _context.next = 10;
          break;
        case 7:
...
var shareForm = document.querySelector('.form--share');
...
if (shareForm) shareForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var performancer = document.getElementById('performancer').value;
  var date = document.getElementById('date').value;
  var location = document.getElementById('location').value;
  var rating = document.getElementById('rating').value;
  var review = document.getElementById('shares').value;
  (0, _share.createReview)(review, rating, performancer, date, location);
});
